...
fun LoginScreen(
    ...
    onLoginSuccess: (String, String, Int) -> Unit, // Updated to accept multiple parameters
                    ...
                    if (isValidEmail(email)) { // Validate email before attempting login
                        authManager.login(email, password) { success, error ->
                            ...
                            if (success) {
                                ...
                                authManager.fetchUserData { username, date, imageResId ->
                                    if (username == null || date == null || imageResId == null) {
                                        navController.navigate("naming") // Navigate to naming screen if any data is missing
                                    } else {
